...
can recover the fused kernel.  We show that this limitation sharpens
beyond triangles: for 4-cycles, diamonds, bow-ties, and $k$-cycles,
no masked SpGEMM formulation exists, and the pairwise gap is
unavoidable for any cyclic graph pattern.
\end{abstract}
